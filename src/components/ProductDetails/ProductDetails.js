...
class ProductDetails extends Component {
    ...
    render() {
        ...
        if(this.state.previewImg==="0"){
            this.setState({previewImg:"http://127.0.0.1:8000/"+img1})
        }
                                        ...
                                        <Container className="my-3">
                                            <Row>
                                                <Col className="p-0 image-box m-0"  md={3} lg={3} sm={3} xs={3}>
                                                    <img onClick={this.imgOnclick} className="w-100 Product-sm-img" src={"http://127.0.0.1:8000/"+img2} alt=""/>
                                                </Col>
                                                <Col className="p-0 image-box m-0" md={3} lg={3} sm={3} xs={3}>
                                                    <img onClick={this.imgOnclick} className="w-100 Product-sm-img" src={"http://127.0.0.1:8000/"+img3} alt=""/>
                                                </Col>
                                                <Col className="p-0 image-box m-0" md={3} lg={3} sm={3} xs={3}>
                                                    <img onClick={this.imgOnclick} className="w-100 Product-sm-img" src={"http://127.0.0.1:8000/"+img4} alt=""/>
                                                </Col>
                                                <Col className="p-0 image-box m-0" md={3} lg={3} sm={3} xs={3}>
                                                    <img onClick={this.imgOnclick} className="w-100 Product-sm-img" src={"http://127.0.0.1:8000/"+img1} alt=""/>
                                                </Col>
                                            </Row>
                                        </Container>
                                    </Col>
